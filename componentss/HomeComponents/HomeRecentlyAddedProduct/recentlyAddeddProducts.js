...
import styles from "./recentlyAddeddProducts.module.scss";
...
function HomeRecentlyAddeddProducts(props) {
      ...
      <div>
        <div className={styles.sub_container}>
          <div className={styles.heading}>
            <h2>
              Recently Added Products</h2></div>
...
export default HomeRecentlyAddeddProducts;
